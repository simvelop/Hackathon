...
public class ConferenceActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mConference = (Conference) getIntent().getSerializableExtra("hr.droidcon.conference.hack");
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                Uri.parse("android-app://hr.droidcon.hr.droidcon.conference.hack.hr.droidcon.conference.hack/http/host/path")
        );
